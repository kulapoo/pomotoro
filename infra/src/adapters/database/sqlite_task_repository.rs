...
use super::{DbPool, models::TaskDb};
...
impl TaskRepository for SqliteTaskRepository {
    ...
    async fn get_by_tags(&self, tags: &[String]) -> Result<Vec<Task>> {
        ...
        let tasks_db = query.load::<TaskDb>(&mut conn)
            .map_err(|e| Error::RepositoryError {
    ...
    async fn search(&self, options: SearchOptions) -> Result<Vec<Task>> {
        ...
        if let Some(sort_by) = options.sort_by {
            ...
            query = match (sort_by, order) {
                (SortBy::Name, SortOrder::Ascending) => query.order_by(tasks::name.asc()),
                (SortBy::Name, SortOrder::Descending) => query.order_by(tasks::name.desc()),
                (SortBy::CreatedAt, SortOrder::Ascending) => query.order_by(tasks::created_at.asc()),
                (SortBy::CreatedAt, SortOrder::Descending) => query.order_by(tasks::created_at.desc()),
                (SortBy::SessionsCompleted, SortOrder::Ascending) => query.order_by(tasks::current_sessions.asc()),
                (SortBy::SessionsCompleted, SortOrder::Descending) => query.order_by(tasks::current_sessions.desc()),
                (SortBy::Status, SortOrder::Ascending) => query.order_by(tasks::status.asc()),
                (SortBy::Status, SortOrder::Descending) => query.order_by(tasks::status.desc()),
            };
        }
