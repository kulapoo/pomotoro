    ...
    fn from(config: Config) -> Self {
        ...
        Self {
            ...
            notification: NotificationConfigDto {
                enable_desktop_notifications: config
                    .notification
                    .enable_desktop_notifications,
                enable_sound_notifications: config
                    .notification
                    .enable_sound_notifications,
                show_phase_transition_notifications: config
                    .notification
                    .show_phase_transition_notifications,
                show_task_completion_notifications: config
                    .notification
                    .show_task_completion_notifications,
                notification_position: match config
                    .notification
                ...
                auto_dismiss_delay_seconds: config
                    .notification
            ...
            appearance: AppearanceConfigDto {
                ...
                show_seconds_in_display: config
                    .appearance
                    .show_seconds_in_display,
                always_on_top: config.appearance.always_on_top,
                compact_mode: config.appearance.compact_mode,
                show_task_list_sidebar: config
                    .appearance
                    .show_task_list_sidebar,
...
impl TryFrom<ConfigDto> for Config {
    ...
    fn try_from(dto: ConfigDto) -> Result<Self> {
        use domain::{
            AppearanceConfig, AudioConfig, GeneralConfig, NotificationConfig,
            TaskDefaults,
        };
        use domain::{Error, NotificationPosition, TaskCyclingBehavior, Theme};
        ...
        let task_cycling_behavior =
            match dto.general.task_cycling_behavior.as_str() {
                ...
                _ => {
                    return Err(Error::ConfigurationError {
                        message: format!(
                            "Invalid task cycling behavior: {}",
                            dto.general.task_cycling_behavior
                        ),
                    });
                }
            };
        ...
        let general_config = GeneralConfig {
            ...
            auto_start_work_after_break: dto
                .general
                .auto_start_work_after_break,
        ...
        let notification_position =
            match dto.notification.notification_position.as_str() {
                ...
                _ => {
                    return Err(Error::ConfigurationError {
                        message: format!(
                            ...
                            dto.notification.notification_position
                        ),
                    });
                }
            };
        ...
        let notification_config = NotificationConfig {
            enable_desktop_notifications: dto
                .notification
                .enable_desktop_notifications,
            enable_sound_notifications: dto
                .notification
                .enable_sound_notifications,
            show_phase_transition_notifications: dto
                .notification
                .show_phase_transition_notifications,
            show_task_completion_notifications: dto
                .notification
                .show_task_completion_notifications,
            notification_position,
            auto_dismiss_delay_seconds: dto
                .notification
                .auto_dismiss_delay_seconds,
        };
