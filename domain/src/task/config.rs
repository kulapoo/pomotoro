...
impl Config {
    ...
    pub fn work_duration(&self) -> Duration { self.work_duration }
    pub fn short_break_duration(&self) -> Duration { self.short_break_duration }
    pub fn long_break_duration(&self) -> Duration { self.long_break_duration }
    pub fn sessions_until_long_break(&self) -> u8 { self.sessions_until_long_break }
    pub fn enable_screen_blocking(&self) -> bool { self.enable_screen_blocking }
