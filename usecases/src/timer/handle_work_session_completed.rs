use domain::{WorkSessionCompleted, TaskRepository, EventPublisher, Result};
use crate::task::complete_session as complete_task_session;
use std::sync::Arc;
...
mod tests {
    ...
    use domain::{Task, NoOpEventPublisher};
