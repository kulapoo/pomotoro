...
mod tests {
    ...
    async fn should_set_default_task() {
        ...
        let result = set_default_task(&task_repo, &event_publisher, cmd)
            .await
            .unwrap();
    ...
    async fn should_unset_previous_default_when_setting_new_one() {
        ...
        set_default_task(&task_repo, &event_publisher, cmd1)
            .await
            .unwrap();
        ...
        let result = set_default_task(&task_repo, &event_publisher, cmd2)
            .await
            .unwrap();
    ...
    async fn should_return_task_if_already_default() {
        ...
        set_default_task(&task_repo, &event_publisher, cmd.clone())
            .await
            .unwrap();
    ...
    async fn should_get_default_task() {
        ...
        set_default_task(&task_repo, &event_publisher, cmd)
            .await
            .unwrap();
