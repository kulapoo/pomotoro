...
impl SettingsViewModel {
    ...
    fn load_config(&self) {
        ...
        spawn_local(async move {
            ...
            invoke::<Config, ()>(event_names::config::GET_GLOBAL, None)
                .await
                .map(|config| {
                    web_sys::console::log_1(
                        &"Successfully loaded config".into(),
                    );
    ...
    fn setup_event_listeners(&self) {
        ...
        spawn_local(async move {
            let callback = Closure::new(move |event: JsValue| {
                ...
                web_sys::console::log_1(
                    &format!("ConfigUpdated event received: {:?}", payload)
                        .into(),
                );
        ...
        spawn_local(async move {
            let callback = Closure::new(move |event: JsValue| {
                ...
                web_sys::console::log_1(
                    &format!("Theme changed event received: {:?}", payload)
                        .into(),
                );
                ...
                from_value::<String>(payload)
                    ...
                    .unwrap_or_else(|| {
                        web_sys::console::error_1(
                            &"Failed to parse theme change event".into(),
                        );
                    });
            });
